...
// const words = `Hello there! I'm a Motivated Software Engineer and AI/ML Enthusiast and I work on JSP, React, Angular, Lightning Web Components, MuleSoft, Spring and Java Programming Technologies, seeking a challenging role to leverage my expertise in Web services, software design, cloud computing, and troubleshooting within a dynamic and collaborative team.`;
